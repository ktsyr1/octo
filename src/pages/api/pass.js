...
export default async function auth(req, res, next) {
        ...
        PATCH(async () => {
                ...
                if (!USER) Send({ msg: " الايميل غير صحيح " })
                        ...
                        <center>
                        <br/><br/>
                        <a href="${urlV}"  style="background-color: #9C27B0; padding: 10px; color: #fff; text-decoration: none; margin: 0 auto; width: 150px; text-align: center; display: block; font-size: 15px;">  اعادة تعيين كلمة السر </a>
                </center>
                `
                        const mailOptions = {
                                from: user,
